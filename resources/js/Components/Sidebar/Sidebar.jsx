...
import { Link, usePage } from "@inertiajs/react"; // Inertia.js components
import ClickOutside from "@/Components/ClickOutside"; // Assuming you have a ClickOutside component
import SidebarItem from "@/Components/Sidebar/SidebarItem"; // Import SidebarItem
...
const menuGroupsGuru = [
    {
        ...
        menuItems: [
...

            {
                icon: (
                    ...
                    >
                        <g clipPath="url(#clip0)">
                            <path
                                d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm1.07-7.75l-.9.92C11.45 11.9 11 12.5 11 14H9v-.5c0-1.1.45-2.1 1.17-2.83l1.24-1.26C12.14 9 12 8.5 12 8a2 2 0 114 0h-2a.5.5 0 10-1 0c0 .28.22.5.5.5.5 0 1.1.45 1.07 1.25z"
                                fill="currentColor"
                            />
                        </g>
                        <defs>
                ...
                label: "Buat Soal Otomatis",
                route: "/guru/generated-soal",
            },

            {
                ...
                >
                    <g clipPath="url(#clip0_130_9763)">
                        <path
                            d="M12 2C12.5523 2 13 2.44772 13 3V5C13 5.55228 12.5523 6 12 6C11.4477 6 11 5.55228 11 5V3C11 2.44772 11.4477 2 12 2ZM4.22216 4.22216C4.60976 3.83456 5.23478 3.83456 5.62238 4.22216L7.05025 5.65003C7.43785 6.03763 7.43785 6.66266 7.05025 7.05025C6.66266 7.43785 6.03763 7.43785 5.65003 7.05025L4.22216 5.62238C3.83456 5.23478 3.83456 4.60976 4.22216 4.22216ZM2 12C2 11.4477 2.44772 11 3 11H5C5.55228 11 6 11.4477 6 12C6 12.5523 5.55228 13 5 13H3C2.44772 13 2 12.5523 2 12ZM17.9498 5.65003C17.5622 6.03763 17.5622 6.66266 17.9498 7.05025C18.3374 7.43785 18.9624 7.43785 19.35 7.05025L20.7779 5.62238C21.1654 5.23478 21.1654 4.60976 20.7779 4.22216C20.3903 3.83456 19.7652 3.83456 19.3776 4.22216L17.9498 5.65003ZM12 18C12.5523 18 13 18.4477 13 19V21C13 21.5523 12.5523 22 12 22C11.4477 22 11 21.5523 11 21V19C11 18.4477 11.4477 18 12 18ZM19.35 16.9498C18.9624 16.5622 18.3374 16.5622 17.9498 16.9498C17.5622 17.3374 17.5622 17.9624 17.9498 18.35L19.3776 19.7779C19.7652 20.1654 20.3903 20.1654 20.7779 19.7779C21.1654 19.3903 21.1654 18.7652 20.7779 18.3776L19.35 16.9498ZM12 8C9.23858 8 7 10.2386 7 13C7 15.7614 9.23858 18 12 18C14.7614 18 17 15.7614 17 13C17 10.2386 14.7614 8 12 8ZM12 16C10.3431 16 9 14.6569 9 13C9 11.3431 10.3431 10 12 10C13.6569 10 15 11.3431 15 13C15 14.6569 13.6569 16 12 16ZM3 19.7779C3.3876 20.1654 4.01263 20.1654 4.40023 19.7779L5.8281 18.35C6.2157 17.9624 6.2157 17.3374 5.8281 16.9498C5.44051 16.5622 4.81548 16.5622 4.42789 16.9498L3 18.3776C2.6124 18.7652 2.6124 19.3903 3 19.7779Z"
                            fill="currentColor"
                        />
                    </g>
                    <defs>
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
    ...
    const { url } = usePage(); // Inertia.js hook to get the current route

    // Derive the current page name from the URL (assuming it is the last segment of the path)
    const pageName = url.split("/").pop() || "dashboard"; // Default to "dashboard" if the URL is root
