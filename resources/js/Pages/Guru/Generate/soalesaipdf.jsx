...
import pdfWorkerSrc from 'pdfjs-dist/build/pdf.worker.mjs?url'; // Untuk Vite
// Kemudian, sebelum Anda menggunakan pdfjsLib untuk pertama kali, set workerSrc:
...
const Esai = () => {
    ...
    function handleChange(e) {
        ...
        if (name === "kelas") {
            setQuestion("classLevel", parseInt(value));
        }
    ...
    const handleOnSaveQuestion = () => {
        ...
        post(route("guru.generated-soal.storepdf"), {
            onSuccess: () => {
                swal.fire({
                    icon: "success",
