import{q as L,r as B,j as e,y as F}from"./app-C6ymd91F.js";import{b as G,c as x,d as _,a as J}from"./index-BrxrZHHK.js";import{R}from"./index-CWXZeEvY.js";import{u as l}from"./store-DnlpstsY.js";import{G as $}from"./index-DiWJTiuy.js";import{l as j}from"./lodash-BQZpEJTV.js";import{w as q}from"./sweetalert2-react-content.es-BwYm20AV.js";import{S as O}from"./sweetalert2.esm.all-9Qm2jZ7z.js";const Q=()=>{const{env:{GEMINI_API_KEY:g,GEMINI_MODEL_NAME:f},subject:N}=L().props,[a,c]=B.useState(null),i=l(s=>s.response),p=l(s=>s.updateResponseByIndex),d=l(s=>s.request),w=l(s=>s.deleteResponse),o=l(s=>s.isLoading),m=l(s=>s.setIsLoading),C=l(s=>s.reset),h=q(O),u=s=>{const{name:t,value:n}=s.target,r=j.cloneDeep(a);j.set(r,t,n),c(r)},S=s=>{const t={...a},n=t.multipleChoice.findIndex(r=>r.isCorrect==!0);n!=-1&&(t.multipleChoice[n].isCorrect=!1),t.multipleChoice[s].isCorrect=!0,c(t)},b=s=>{a!=null&&a.index==s?(p(s,a),c(null)):c({index:s,...i[s]})},k=()=>{i.map(t=>parseFloat(t.weight)).reduce((t,n)=>t+n)!=100?h.fire({icon:"warning",title:"Bobot tidak sesuai",toast:!0,position:"top-end",showConfirmButton:!1,timer:3e3}):F.post(route("guru.generated-soal.store"),{...d,response:i},{onStart:()=>m("SUBMIT"),onSuccess:()=>{C(),h.fire({icon:"success",title:"Soal berhasil disimpan",toast:!0,position:"top-end",showConfirmButton:!1,timer:3e3})},onFinish:()=>m(null)})},y=async(s,t)=>{try{m(`SINGLE-${s}`);const r=new $(g).getGenerativeModel({model:f}),v=N.find(A=>A.id==d.subject).name,I=`
