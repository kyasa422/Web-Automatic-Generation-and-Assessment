import{q as E,j as a}from"./app-Q_4SmkLU.js";import{u as t}from"./store-dcOH6P2c.js";import{G as T}from"./index-DiWJTiuy.js";const j=()=>{const{env:{GEMINI_API_KEY:o,GEMINI_MODEL_NAME:l},subject:p}=E().props,s=t(e=>e.request),c=t(e=>e.setRequest),n=t(e=>e.response),u=t(e=>e.updateResponse),r=t(e=>e.isLoading),i=t(e=>e.setIsLoading),C=e=>c(e.target),b=async()=>{try{i(n.length>0?"ADD":"ALL");const d=new T(o).getGenerativeModel({model:l}),m=p.find(h=>h.id==s.subject).name,y=s.type==0?"UTS":"UAS",w=`
